...
Publish the image to a registry after logging in:

```bash
docker login
docker tag bulletin-board:local YOUR_REGISTRY/bulletin-board:latest
docker push YOUR_REGISTRY/bulletin-board:latest
```
